...
1. [Configure the proxy yourself](#configuring-the-proxy-manually)
2. Enable CORS on your server ([here’s how to do it for Express](http://enable-cors.org/server_expressjs.html)).
3. Use [environment variables](adding-custom-environment-variables.md) to inject the right server host and port into your app.
...
> Note
>
> This is dangerous and exposes your machine to remote code execution from malicious websites. DANGEROUSLY_DISABLE_HOST_CHECK=true
