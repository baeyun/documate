...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../node_modules/@mdx-js/tag/dist/mdx-provider.js":[function(require,module,exports) {
'use strict';
...
},{"react":"../node_modules/react/index.js"}],"../node_modules/@mdx-js/tag/dist/mdx-tag.js":[function(require,module,exports) {
'use strict';
...
},{"react":"../node_modules/react/index.js","./mdx-provider":"../node_modules/@mdx-js/tag/dist/mdx-provider.js"}],"../node_modules/@mdx-js/tag/dist/index.js":[function(require,module,exports) {
'use strict';
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./mdx-tag":"../node_modules/@mdx-js/tag/dist/mdx-tag.js","./mdx-provider":"../node_modules/@mdx-js/tag/dist/mdx-provider.js"}],"../node_modules/ressheet/index.js":[function(require,module,exports) {
"use strict";
...
class RESSheet {
  constructor(props, RESSheet) {
    if (typeof props !== 'object' && props.constructor !== Object) throw Error('Provide props to validate styles');
    if (typeof RESSheet !== 'object' && RESSheet.constructor !== Object) throw Error('Provide an appropriate RESSheet');
    this.styleObj = {};
    return this._evaluateRESS(this._qualifyProps(props), RESSheet);
  }
  /*
   * qualifyProps
   *
  ...
  _qualifyProps(rawPropsObj) {
    ...
    for (let prop in rawPropsObj) if (rawPropsObj[prop]) qualifiedProps.push(prop);
  ...
  _arrayInArray(arr1, arr2) {
    if (typeof arr1 !== 'array' && arr1.constructor !== Array || typeof arr2 !== 'array' && arr2.constructor !== Array) throw Error('Please provide arrays as args');

    for (let i = 0; i < arr1.length; i++) if (arr2.includes(arr1[i])) return true;
  ...
  _evaluateRESS(qualifiedProps, RESSheet, selector = null) {
    if (selector) {
      if (this._arrayInArray(qualifiedProps, selector.split(/\s*\,\s*/))) for (let k in RESSheet) {
        let styleVal = RESSheet[k];
        if (typeof styleVal === 'object' && styleVal.constructor === Object || styleVal === null // cater for null value in React Native
        ) // Recursion of this._evaluateRESS() if property is object
          this._evaluateRESS(qualifiedProps, styleVal, k);else this.styleObj[k] = styleVal;
      } else return null;
    } else for (let selector in RESSheet) {
      if (this._arrayInArray(qualifiedProps, selector.split(/\s*\,\s*/)) || selector.includes('default')) for (let k in RESSheet[selector]) {
        let styleVal = RESSheet[selector][k];
        if (typeof styleVal !== 'object' && styleVal.constructor !== Object || styleVal === null // cater for null value in React Native
        ) this.styleObj[k] = styleVal;else // Handle nested styles
          this._evaluateRESS(qualifiedProps, RESSheet[selector][k], k);
      }
    }
...
exports.default = RESSheet;
},{}],"../src/components/Breadcrumb.js":[function(require,module,exports) {
"use strict";
...
var _ressheet = _interopRequireDefault(require("ressheet"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = function _default(props) {
  var breadcrumbStyles = new _ressheet.default(props, {
    default: {
  ...
  if (!props.slugs) throw Error('The [slug] prop was not defined.');
  return _react.default.createElement("div", {
    style: breadcrumbStyles
  }, props.slugs.map(function (slug, i) {
...
},{"react":"../node_modules/react/index.js","ressheet":"../node_modules/ressheet/index.js"}],"../src/components/logo.js":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _default = "data:image/png;base64,";
exports.default = _default;
},{}],"../src/containers/Sidenav.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  _createClass(Sidebar, [{
    key: "render",
    value: function render() {
      var sidenavStyles = new _ressheet.default(this.props, {
        default: {
...
},{"react":"../node_modules/react/index.js","ressheet":"../node_modules/ressheet/index.js","../components/logo":"../src/components/logo.js"}],"../src/components/Button.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(props) {
  var buttonStyles = new _ressheet.default(props, {
    default: {
      backgroundColor: '#eee',
      color: '#333',
      padding: '8px 12px',
    ...
    'success': {
      backgroundColor: '#3fb944'
    },
    'warning': {
      backgroundColor: '#FFB300'
    },
    'danger': {
      backgroundColor: '#dc3131'
    },
    'pullLeft': {
      float: 'left'
    },
...
exports.default = _default;
},{"react":"../node_modules/react/index.js","ressheet":"../node_modules/ressheet/index.js"}],"../src/components/Alert.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Alert, [{
    ...
    value: function componentWillMount() {
      ...
      [{
        ...
        if (_ref.props[config.alertType]) _ref.setState({
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", _extends({
        style: alertStyles
      }, this.props), _react.default.createElement("i", {
        style: {
          marginRight: 5,
          fontSize: 20,
...
},{"react":"../node_modules/react/index.js","ressheet":"../node_modules/ressheet/index.js"}],"../src/components/Code.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(props) {
  var codeStyles = new _ressheet.default(props, {});
...
exports.default = _default;
},{"react":"../node_modules/react/index.js","ressheet":"../node_modules/ressheet/index.js"}],"../src/containers/Topbar.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  _createClass(Topbar, [{
    key: "render",
    value: function render() {
      var topbarStyles = new _ressheet.default(this.props, {
        default: {
          height: 60,
          padding: '15px 20px'
        }
      ...
      })), this.props.menu && _react.default.createElement(Topbar.Menu, {
...
},{"react":"../node_modules/react/index.js","ressheet":"../node_modules/ressheet/index.js"}],"../src/containers/Main.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  _createClass(Main, [{
    key: "render",
    value: function render() {
      var mainStyles = new _ressheet.default(this.props, {
        default: {
      ...
      return _react.default.createElement("main", {
        id: "Main",
        style: mainStyles
      }, this.props.topbar === true && _react.default.createElement(_Topbar.default, {
        menu: this.props.menu || false
      }), _react.default.createElement("div", {
        id: "content",
        style: _objectSpread({}, contentStyles)
      }, this.props.children));
    }
  }]);
...
},{"react":"../node_modules/react/index.js","ressheet":"../node_modules/ressheet/index.js","./Topbar":"../src/containers/Topbar.js"}],"index.mdx":[function(require,module,exports) {
"use strict";
...
var _Breadcrumb = _interopRequireDefault(require("../src/components/Breadcrumb"));

var _Sidenav = _interopRequireDefault(require("../src/containers/Sidenav"));
...
var _Code = _interopRequireDefault(require("../src/components/Code"));
...
function (_React$Component) {
  ...
  _createClass(MDXContent, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_tag.MDXTag, {
      ...
      }, _react.default.createElement(_Sidenav.default, null, _react.default.createElement(_Sidenav.default.Logo, {
        src: "./img/logo.png"
        ...
        primary: true
      }, "This is a primary alert."), _react.default.createElement(_Alert.default, {
        success: true
      }, "This is a success alert."), _react.default.createElement(_Alert.default, {
        warning: true
      ...
      }, "Property"), _react.default.createElement(_tag.MDXTag, {
        name: "th",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "Parameter"), _react.default.createElement(_tag.MDXTag, {
        name: "th",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "Default"), _react.default.createElement(_tag.MDXTag, {
        name: "th",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "Return value"))), _react.default.createElement(_tag.MDXTag, {
        name: "tbody",
        components: components,
        parentName: "table"
      }, _react.default.createElement(_tag.MDXTag, {
      ...
      }, "updateScheduleSync"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
        ...
        parentName: "td",
        props: {
          "href": "http://localhost:1234/docs/dom-updates/BatchedUpdate"
        }
      }, "BatchedUpdate")), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "new BatchedUpdate()"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "ScheduleType")), _react.default.createElement(_tag.MDXTag, {
        name: "tr",
        components: components,
        parentName: "tbody"
      }, _react.default.createElement(_tag.MDXTag, {
      ...
      }, "generateFromScheduledTask"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "string"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "'DEFAULT_TASK'"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "defineComponent"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "ComponentConfig"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "new ComponentConfig()"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "Component")), _react.default.createElement(_tag.MDXTag, {
        name: "tr",
        components: components,
        parentName: "tbody"
      }, _react.default.createElement(_tag.MDXTag, {
      ...
      }, "migrateMixin"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "Mixin"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "Mixin or Error")), _react.default.createElement(_tag.MDXTag, {
        name: "tr",
        components: components,
        parentName: "tbody"
      }, _react.default.createElement(_tag.MDXTag, {
      ...
      }, "refineSurfaceModel"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "int"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
      ...
      }, "0 (initial surface)"), _react.default.createElement(_tag.MDXTag, {
        name: "td",
        components: components,
        parentName: "tr",
        props: {
...
},{"react":"../node_modules/react/index.js","@mdx-js/tag":"../node_modules/@mdx-js/tag/dist/index.js","../src/components/Breadcrumb":"../src/components/Breadcrumb.js","../src/containers/Sidenav":"../src/containers/Sidenav.js","../src/components/Button":"../src/components/Button.js","../src/components/Alert":"../src/components/Alert.js","../src/components/Code":"../src/components/Code.js","../src/containers/Main":"../src/containers/Main.js"}],"../src/main.js":[function(require,module,exports) {
"use strict";
...
var _index = _interopRequireDefault(require("../documate/index.mdx"));
...
var overrideComponents = {
  ...
  blockquote: function blockquote(props) {
    return _react.default.createElement("blockquote", _extends({
      style: _objectSpread({}, defaultStyles.blockquote)
    }, props));
  },
  table: function table(props) {
    return _react.default.createElement("div", {
      style: _objectSpread({}, defaultStyles.fixedTableLayout),
      children: _react.default.createElement("table", props)
    });
  },
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","@mdx-js/tag":"../node_modules/@mdx-js/tag/dist/index.js","../documate/index.mdx":"index.mdx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/main.da4909e4.map